...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 5593420376332656608),
      name: 'Group',
      lastPropertyId: const IdUid(3, 2923712515482088296),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 6029174091157637055),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 8724803901598515304),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 2923712515482088296),
            name: 'color',
            type: 6,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(2, 9163264356518503814),
      name: 'Task',
      lastPropertyId: const IdUid(4, 9211747112043772938),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 5593540086523855059),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 2539358726045280629),
            name: 'description',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 8783326436255747875),
            name: 'completed',
            type: 1,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 9211747112043772938),
            name: 'groupId',
            type: 11,
            flags: 520,
            indexId: const IdUid(1, 1713890973176882818),
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(2, 9163264356518503814),
      lastIndexId: const IdUid(1, 1713890973176882818),
